#!/usr/bin/env python3
# gateway_v7.2.py - Adaptive Polling Interval
# Deskripsi: Gateway IEC 61850 ke IEC 60870-5-104.
# Fitur v7.2: Polling interval adaptif. Lama jika report sukses, cepat jika report gagal.
...
async def main():
    ...
    logger.info("Gateway v7.2 (Adaptive Polling) started")
